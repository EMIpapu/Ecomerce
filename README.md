...
├── confirmation.html       # Página de confirmación
├── styles.css             # Estilos principales
├── checkout.css           # Estilos específicos del checkout
├── script.js              # JavaScript principal
├── checkout.js            # JavaScript del checkout
├── imgs/                  # Imágenes de productos
│   ├── difusor-de-aceites.webp
│   ├── hidrolavadora-ryobi.webp
│   ├── ipad-a16.webp
│   ├── juego-de-dados.webp
│   ├── oppo-find-n5.webp
│   └── perfume-adolfo-dominguez-ambar-negro.webp
...
1. **Clonar el repositorio**:
   ```bash
   git clone https://github.com/EMIpapu/Ecomerce.git
   ```
...
|----------|-----------|--------|-------|
| Difusor de Aceites Esenciales | Hogar | $89.99 | 15 |
| Hidrolavadora RYOBI | Herramientas | $299.99 | 8 |
| iPad con chip A16 | Electrónicos | $899.99 | 12 |
| Juego de Dados Premium | Hogar | $24.99 | 25 |
